...
async function sendWeddingCountdownTestEmail() {
  try {
    console.log('Sending test wedding countdown email...');
    
    const testEmail = 'kareem@entendre.finance'; // Change this to your test email
    const testName = 'Kareem'; // Change this to your test name
...
<body>
  <div class="container">
    ...
    console.log(`Successfully sent test countdown email to ${testEmail}`);
  } catch (error) {
    console.error('Error sending test countdown email:', error);
    console.error('Error details:', JSON.stringify(error, null, 2));
  }
}

// Execute the function
sendWeddingCountdownTestEmail(); 